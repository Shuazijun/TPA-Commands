...
public class RTPCDCommand extends ModularChatCommand {
    private final RTPListener rtpListener;

    public RTPCDCommand(String name, RTPListener rtpListener) {
        super(name, "设置随机传送冷却时间（秒）", PermissionLevel.ADMIN, false,
    ...
    public void runModular(Client client, Server server, ServerClient serverClient, Object[] args, String[] errors, CommandLog logs) {
        ...
        rtpListener.setCooldownSeconds(seconds);
        logs.add("随机传送冷却时间已设置为 " + seconds + " 秒");
    }
