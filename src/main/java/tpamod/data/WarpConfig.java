...
public class WarpConfig {
    ...
    public WarpConfig() {
        this.configFile = new File("config/tpamod/warpconfig.dat");
        loadConfig();
    }
        ...
        try {
            if (configFile.exists()) {
                ...
                if (savedCooldown >= 1 && savedCooldown <= 3600) {
                    ...
                    System.out.println("Warp System: Loaded cooldown time: " + savedCooldown + " seconds");
                }
            }
        } catch (Exception e) {
            System.out.println("Warp System: Using default cooldown time (15 seconds)");
        }
    }
}